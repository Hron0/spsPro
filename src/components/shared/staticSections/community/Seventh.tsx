...
export const Seventh = async () => {
    return (
        <section
            ...
            <div
                className={"container px-6 lg:px-16 py-4 lg:py-8 pt-8 lg:pt-14 text-white h-min flex flex-row items-start gap-6 md:gap-32 relative w-full"}>

                <div
                    className={"relative bg-background w-[1000px] aspect-square px-1 py-2 rounded-md flex flex-col items-center justify-start gap-2 justify-between shadow-xl text-black"}>
                ...
                <h1 className={'text-4xl font-normal text-white text-center'}>
