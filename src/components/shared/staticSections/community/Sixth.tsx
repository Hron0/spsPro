    ...
    return (
        <section
            ...
            <div
                ...
                <TitleHeader title={'Защита от недовольных клиентов'} color={'orange'} cClass={'md:w-fit pr-8'}/>

                <div
                    className={"relative w-full flex flex-col gap-16 py-6 md:py-16 md:pr-24 lg:pr-[28%] items-start justify-start text-black text-4xl font-extralight"}>
