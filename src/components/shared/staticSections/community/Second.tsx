...
export default function Second() {
    return (
        <section
            className={'container relative px-6 lg:px-16 py-4 lg:py-8  h-min text-black md:aspect-video'}>
            <div className={"flex flex-col items-start gap-6 md:gap-24 bg-romb bg-center bg-contain bg-no-repeat relative w-full h-full"}>
                ...
                <div
                    ...
                    <ul className={'list-none list-inside text-xl lg:text-4xl font-extralight indent-8'}>
