        ...
        <section
            ...
            <div
                ...
                <div className={"flex flex-col gap-2 lg:gap-16 lg:row-span-3 lg:self-end px-0 lg:px-32"}>
                    <h1 className={"text-3xl lg:text-4xl font-bold uppercase z-10 text-center"}>Система добровольной сертификации
                    "профессионал"</h1>
                    <h3 className={"md:text-xl lg:text-2xl text-center font-extralight z-10 whitespace-pre-line break-words self-center"}>
